...
public class Exercise2Test extends ClassicOnlineStore {
    ...
    public void descSortByAge() {
         ...
         */
        Comparator<Integer> descOrder = (a, b) -> a > b ? -1 : a == b ? 0 : 1;
    ...
    public void top3RichCustomer() {
         ...
         */
//        Stream<String> top3RichCustomerStream = customerList.stream().sorted((a, b) -> a.getBudget() > b.getBudget() ? -1 : a.getBudget() == b.getBudget() ? 0  : 1 ).map(Customer::getName).limit(3);
        Stream<String> top3RichCustomerStream = customerList.stream().sorted((a, b) -> a.getBudget().compareTo(b.getBudget()) * -1).map(Customer::getName).limit(3);
