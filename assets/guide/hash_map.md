...
соображениях, описанных в книге "Effective Java" авторства Джошуа Блоха. Позвольте мне объяснить, почему именно 31
является предпочтительным выбором для таких расчетов:
